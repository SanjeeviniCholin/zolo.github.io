...
<?php require('inc/header.php')?>
	...
	<div class="my-5 px-4">
		<h2 class="fw-bold h-font text-center">MALNAD PG</h2>
		...
		<div class="row">
					...
					<div class="container-fluid flex-lg-column align-items-stretch">
						...
						<div class="collapse navbar-collapse flex-column align-items-stretch mt-2" id="filterDropdown">
							<div class="border bg-light p-3 rounded mb-3">
								...
								<input class="form-control shadow-none mb-3" type="text" value="Malnad pg road, Bangalore - Mangalore Rd, behind Bhanu Theatre, Karigowda Colony, Rangoli Halla, Hassan, Karnataka 573201" placeholder="Location">
			...
			<div class="col-lg-9 px-4">
				...
				<div class="card mb-4 border-0 shadow">
					<div class="row g-0 p-3 align-items-center">
						<div class="col-md-5 mb-lg-0">
						<img src="images/malnadmen/2.jpeg" class="img-fluid rounded" width=400px>
						</div>
						<div class="col-md-5 px-lg-3">
				...
				<div class="card mb-4 border-0 shadow">
					<div class="row g-0 p-3 align-items-center">
						<div class="col-md-5 mb-lg-0">
						<img src="images/malnadmen/3.jpeg" class="img-fluid rounded" width=400px>
						</div>
						<div class="col-md-5 px-lg-3">
