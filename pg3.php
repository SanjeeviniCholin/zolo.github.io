...
<?php require('inc/header.php')?>
	...
	<div class="my-5 px-4">
		<h2 class="fw-bold h-font text-center">DREAM STAYS PG</h2>
					...
					<div class="container-fluid flex-lg-column align-items-stretch">
						...
						<div class="collapse navbar-collapse flex-column align-items-stretch mt-2" id="filterDropdown">
							<div class="border bg-light p-3 rounded mb-3">
								...
								<input class="form-control shadow-none mb-3" type="text" value="Dulhan, opposite Govt Primary school, near Maratha Mandal Polytechnic, Subhash Nagar, Belagavi, Karnataka 590016" placeholder="Location">
